...
import { Moon, Sun, ShieldCheck, Zap, Globe, Play, Users, Building, Heart, ChevronDown, Mail, Stethoscope, Menu, X } from 'lucide-react';
...
const LandingPage = () => {
    ...
    const menuData = {
        ...
        'Products': {
            ...
            columns: [
                { title: 'Operations Suite', links: [{ name: 'Point of sale', url: 'https://hudi-pos-online.onrender.com' }, { name: 'Hospital Management (HMS)', url: 'https://hudi-soft-com-sz9e.vercel.app/', isNew: true }, { name: 'Detail Care Clinic PWA', url: 'https://hudi-soft-com-2g8v.vercel.app/login', isNew: true }, { name: 'Catering & events', url: '#' }, { name: 'HUDI Mobile Order', url: '#', isNew: true }, { name: 'Payment processing', url: '#' }] },
    ...
    return (
        <div className="min-h-screen relative overflow-hidden bg-slate-50 dark:bg-slate-900 transition-colors duration-500 text-slate-900 dark:text-slate-50">
                ...
                <div className="max-w-[1400px] mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="hidden md:flex items-center gap-3">
                            ...
                            <Link to="/request-demo" className="px-6 py-2.5 text-sm font-black text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition-colors shadow-lg shadow-blue-500/20 whitespace-nowrap flex items-center gap-2">
                                <Zap size={14} fill="currentColor" />
                                Get Professional Demo
                            </Link>
                        </div>
            ...
            <AnimatePresence>
                {mobileMenuOpen && (
                    <motion.div
                        ...
                        className="fixed top-20 left-0 right-0 bottom-0 z-40 bg-white/95 backdrop-blur-xl md:hidden flex flex-col p-8 gap-6 overflow-y-auto border-t border-slate-100"
                    >
                        <nav className="flex flex-col gap-2">
                            {['Restaurants', 'Retail', 'Products', 'Pricing', 'Resources'].map((item) => (
                                <button key={item} onClick={() => setMobileMenuOpen(false)}
                                    className="text-left text-xl font-black text-slate-800 py-4 border-b border-slate-100 hover:text-blue-600 transition-colors flex justify-between items-center">
                                    {item} <ChevronDown size={18} className="text-slate-400" />
                                </button>
                            ))}
                        </nav>
                        <div className="flex flex-col gap-4 mt-4">
                            <Link to="/request-demo"
                                ...
                                className="w-full py-5 bg-blue-600 text-white rounded-2xl font-black text-center text-lg hover:bg-blue-700 transition-all shadow-xl shadow-blue-500/20 flex items-center justify-center gap-3">
                                <Zap size={18} fill="currentColor" /> Get Professional Demo
                            </Link>
                            <Link to="/admin/login"
                                onClick={() => setMobileMenuOpen(false)}
                                className="w-full py-5 border-2 border-blue-600 text-blue-600 rounded-2xl font-black text-center text-lg hover:bg-blue-50 transition-all flex items-center justify-center gap-3">
                                Login
                            </Link>
                        </div>
                        <div className="mt-auto pt-6 border-t border-slate-100">
                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 text-center">© 2026 HUDI SOFT SYSTEMS • MOGADISHU HQ</p>
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-sm font-bold text-slate-600 uppercase tracking-widest">Enterprise Trust • 164,000+ Locations</span>
                        </motion.div>

                        <h1 className="text-6xl md:text-8xl font-black tracking-tight leading-[0.9] text-slate-900">
                            Empowering <br />
                            <span className="text-blue-600 italic">Modern Business.</span>
                        </h1>

                        <p className="text-xl md:text-2xl text-slate-600 font-light max-w-xl leading-relaxed">
                            Start your <span className="font-bold text-blue-600">3-Day Free Trial</span> today. Professional POS and <a href="https://hudi-soft-com-sz9e.vercel.app/" target="_blank" rel="noopener noreferrer" className="font-bold text-rose-500 underline decoration-rose-200 hover:text-rose-600 transition-colors">HMS PWA</a> systems built for scale.
                        </p>
                        ...
                        <div className="max-w-md">
                            <form className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white border-2 border-slate-200 pl-16 pr-44 py-6 rounded-[2rem] outline-none focus:border-blue-600 focus:ring-8 focus:ring-blue-600/5 transition-all font-bold text-lg shadow-xl shadow-slate-100"
                                />
                                <button className="absolute right-2 top-2 bottom-2 px-8 bg-blue-600 text-white rounded-[1.5rem] font-black uppercase text-xs tracking-widest hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20 active:scale-[0.98]">
                                    Get Demo
                                </button>
                            </form>
                            <p className="mt-4 text-xs font-bold text-slate-500">
                                🏥 Medical Center? <a href="https://hudi-soft-com-sz9e.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-rose-500 hover:underline">Launch HMS PWA Demo immediately →</a>
                            </p>
                    ...
                    >
                        ...
                        <motion.div 
                            ...
                            className="relative p-4 rounded-[4rem] bg-gradient-to-br from-blue-600 to-purple-600 shadow-[0_50px_100px_rgba(37,99,235,0.2)] overflow-hidden group"
                        >
                            <div className="relative aspect-[16/11] bg-slate-900 rounded-[3.5rem] overflow-hidden shadow-inner border border-white/20">
                                <img
                                    src="/images/ONE.jpg"
                                    alt="HUDI POS"
                                ...
                                <div className="absolute inset-0 bg-black/40 flex items-center justify-center group-hover:bg-black/20 transition-colors">
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        className="bg-white px-10 py-5 rounded-[2rem] flex items-center gap-4 text-blue-900 font-black shadow-2xl border border-white/50 uppercase text-xs tracking-[0.2em]"
                                    >
                                ...
                                <div className="absolute top-8 right-8">
                                    <div className="bg-orange-600 text-white px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg animate-bounce">
                                        3-Day Free Trial
                                    </div>
                                </div>
                            </div>
            ...
            <section className="relative z-10 py-32 space-y-40">
                ...
                <div id="products" className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="pt-6">
                                <Link to="/request-demo" className="px-8 py-4 bg-blue-600 text-white rounded-2xl font-black text-lg hover:bg-blue-700 transition-colors shadow-xl shadow-blue-500/20 inline-block">
                                    Demo Retail POS
                                </Link>
                            </div>
                        </motion.div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="pt-6 flex flex-wrap gap-4">
                                <a href="https://hudi-soft-com-sz9e.vercel.app/" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-blue-400 text-slate-900 rounded-2xl font-black text-lg hover:bg-blue-300 transition-colors shadow-xl shadow-blue-400/20 inline-flex items-center gap-2">
                ...
                {/* Detail Care System */}
                <div className="max-w-7xl mx-auto px-6 bg-[#0f766e] py-32 lg:rounded-[4rem] text-white">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <motion.div
                            initial={{ opacity: 0, x: -30 }}
                            whileInView={{ opacity: 1, x: 0 }}
                        ...
                        >
                            <h2 className="text-5xl md:text-6xl font-black leading-tight">
                                Specialized <br /> <span className="text-emerald-300">Detail Care Clinic PWA.</span>
                            </h2>
                            <p className="text-xl text-emerald-100 font-light leading-relaxed">
                                Our bespoke clinical management software built for specialized care, telehealth integration, digital patient records, and real-time medical tracking.
                            </p>
                            <ul className="space-y-4">
                                {[
                                    'Specialized patient dashboard & national ID lookup',
                                    'Walk-in queue management & doctor scheduling calendar',
                                    'Integrated pharmacy e-prescriptions & barcode scanner',
                                    'Secure WebRTC video teleconsultation & nurse vitals'
                                ].map((feature, i) => (
                                    <li key={i} className="flex gap-3 items-start">
                                        <div className="mt-1.5 w-5 h-5 rounded-full bg-emerald-400 flex items-center justify-center flex-shrink-0">
                                            <ShieldCheck size={12} className="text-teal-900" />
                                        </div>
                                        <span className="font-bold text-emerald-50">{feature}</span>
                                    </li>
                                ))}
                            </ul>
                            <div className="pt-6 flex flex-wrap gap-4">
                                <a href="http://localhost:3000" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-emerald-400 text-slate-900 rounded-2xl font-black text-lg hover:bg-emerald-300 transition-colors shadow-xl shadow-emerald-400/20 inline-flex items-center gap-2">
                                    <Play size={20} fill="currentColor" />
                        ...
                        <thead>
                            <tr className="bg-slate-50 dark:bg-slate-800/50">
                                ...
                                <th className="p-8 text-center">
                                    <div className="text-xl font-black text-blue-600 uppercase">Enterprise Plan</div>
                                    <div className="text-sm font-bold opacity-50">$400 / One-time</div>
                                </th>
                                <th className="p-8 text-center">
                                    <div className="text-xl font-black uppercase">Monthly Rent</div>
                                    <div className="text-sm font-bold opacity-50">$30 / Month</div>
                                </th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                            {[
                                { name: 'Free Trial', a: '3 Days', b: '3 Days' },
                                ...
                                { name: 'Cost per Month', a: '~$6.60', b: '$30.00' }
                            ].map((row, i) => (
