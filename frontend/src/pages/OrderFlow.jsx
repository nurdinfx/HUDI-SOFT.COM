...
const OrderFlow = () => {
    ...
    const products = [
        ...
        { id: 'DETAIL_CARE', name: 'Detail Care Clinic Management', description: 'Enterprise clinic PWA with teleconsultations' },
        { id: 'DATEL_CLINIC', name: 'Datel Clinic System', description: 'Premium SaaS Clinic Management Platform — appointments, EMR, pharmacy, lab & billing' },
    ];
                ...
                return (
                    ...
                    >
                        ...
                        <p className="text-slate-600 dark:text-slate-400 max-w-md">
                            Thank you for choosing HUDI SOFT. Our team will verify your payment and activate your <b>POS Online License</b> within 24 hours.
                        </p>
                        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl text-left w-full max-w-sm">
                            ...
                            <p className="text-sm text-slate-700 dark:text-slate-300">Keep an eye on your email <b>{formData.email}</b>. You will receive a <b>License Key</b> to activate your POS system.</p>
                        </div>
                        <button
                            onClick={() => navigate('/')}
