...
export const createOrder = async (req, res) => {
  ...
  try {
    ...
    if (paymentMethod === 'credit') {
      ...
      if (!customer.accountType || customer.accountType === 'standard') {
        throw new Error('Customer does not have an active debit or credit account.');
      }
      
      let currentBal = customer.accountType === 'debit' ? customer.balance : customer.creditUsed;
