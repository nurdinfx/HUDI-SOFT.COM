...
router.post('/', async (req, res) => {
    try {
        ...
        else if (lowerSystemType.includes('detail care') || lowerSystemType.includes('datel care')) productType = 'DETAIL_CARE';
        ...
        // Automatically generate a 5-day trial license for POS or HMS
        if (productType) {
